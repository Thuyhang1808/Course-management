...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Course Management System'); ?></title>
            ...
            <nav class="col-md-3 col-lg-2 d-md-block bg-dark sidebar vh-100">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white" href="<?php echo e(route('courses.index')); ?>">
                                <i class="fas fa-book"></i> Courses
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white" href="<?php echo e(route('enrollments.index')); ?>">
...
</html><?php /**PATH C:\PHP Laravel\course-management\resources\views/layouts/master.blade.php ENDPATH**/ ?>